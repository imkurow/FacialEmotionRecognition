...
const emotionRanges = {
    happy: { energy: [0.7, 1], danceability: [0.7, 1], popularity: [0.5,1] },
    sad: { energy: [0, 0.3], danceability: [0, 0.3], popularity: [0.5,1] },
    angry: { energy: [0.7, 1], danceability: [0, 0.3], popularity: [0.5,1] },
    neutral: { energy: [0, 0.5], danceability: [0.7, 1], popularity: [0.5,1] },
    fear: { energy: [0.7, 1], danceability: [0, 0.3], popularity: [0.5,1] },
    surprised: { energy: [0.7, 1], danceability: [0.7, 1], popularity: [0.5,1] },
  };
// Example function to load CSV as JSON
  async function loadTracks() {
    const response = await fetch('/src/filtered_songs.xls');
  ...
  downloadBtn.addEventListener("click", function() {
    ...
    html2canvas(document.getElementById("canvasContainer"), {
        ...
        if (canvas) {
            ...
            link.href = imageData;
            link.download = "canvasContainerImage.png";
